...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final RetorfitLibraryAccessors laccForRetorfitLibraryAccessors = new RetorfitLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>retorfit</b>
     */
    public RetorfitLibraryAccessors getRetorfit() {
        return laccForRetorfitLibraryAccessors;
    }
    ...
    public static class RetorfitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public RetorfitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>retorfit</b> with <b>com.squareup.retrofit2:retrofit</b> coordinates and
         * with version reference <b>retrofit</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("retorfit");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxHiltNavigationCompose</b> with value <b>1.2.0-alpha01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
